...
class RectangleAroundScene(FrisbeeBaseScene):
    ...
    def construct(self):
        ...
        cut_in=MathTex("Cut\ In",font_size=32).next_to(arrow2,RIGHT)
        cut_in_chinese=Text("回切",font_size=24).next_to(cut_in,DOWN)
        cut_in.next_to(attackers[7],RIGHT)
        cut_in_chinese.next_to(cut_in,DOWN)
        forehand=MathTex("Forehand",font_size=32).next_to(arrow3,RIGHT)
        forehand_chinese=Text("正手出盘",font_size=24).next_to(forehand,DOWN)
        forehand.next_to(frisbee,RIGHT)
        forehand_chinese.next_to(forehand,DOWN)
        self.play(Create(arrow2),Create(arrow3),Write(cut_in),Write(forehand))
        self.play(Write(cut_in_chinese),Write(forehand_chinese))
        self.wait(0.5)
        self.play(FadeOut(arrow2),FadeOut(arrow3),FadeOut(cut_in),FadeOut(forehand),FadeOut(cut_in_chinese),FadeOut(forehand_chinese))
        ...
        self.wait(0.5)
        self.high_light_player(attackers[6])
        self.wait(1)
        ...
        self.wait(2)
        self.play(FadeOut(direction_of_attack), FadeOut(direction_of_attack_label),FadeOut(tuli_attackers), FadeOut(attackers_label),FadeOut(tuli_defender), FadeOut(defenders_label),FadeOut(heng_ground),FadeOut(legend_bg),FadeOut(attackers_group),FadeOut(defenders_group),FadeOut(frisbee),FadeOut(handler),FadeOut(defender[1]),FadeOut(attackers[2]),FadeOut(defender[2]),FadeOut(attackers[3]),FadeOut(defenders_group))
        self.wait(1)