...
class scene0(FrisbeeBaseScene):
    def construct(self):
        ...
        UD_text_english=MathTex("MINGNING",font_size=36)
        UD_text_english.shift(DOWN * 2 + RIGHT * 3)
        # 先显示中央标题
        self.play(Write(center_text),Write(center_text_english))
        self.play(Write(UD_text_english))
        self.wait(1)
        self.play(FadeOut(center_text),FadeOut(center_text_english),FadeOut(UD_text_english))
